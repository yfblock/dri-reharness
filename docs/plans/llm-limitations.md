...
本文聚焦“大模型直接作为驱动代码合成器”。Codex 作为长期仓库工程代理的实测记录见 [v4→v5 复盘](engineering-agent-retrospective-v5.md) 和 [v5→v6 oracle/readiness 假阳性复盘](engineering-agent-retrospective-v6.md)。
