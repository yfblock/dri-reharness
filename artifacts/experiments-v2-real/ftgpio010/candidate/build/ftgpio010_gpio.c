...
{
	{ static char __rhcov_fn_ftgpio_priv_from_gc = 0; if (!__rhcov_fn_ftgpio_priv_from_gc) { __rhcov_fn_ftgpio_priv_from_gc = 1; pr_info("[rhcov] ftgpio_priv_from_gc\n"); } }
	return gpiochip_get_data(gc);
}

void ftgpio_gpio_ack_irq(struct irq_data *d)
{
	{ static char __rhcov_fn_ftgpio_gpio_ack_irq = 0; if (!__rhcov_fn_ftgpio_gpio_ack_irq) { __rhcov_fn_ftgpio_gpio_ack_irq = 1; pr_info("[rhcov] ftgpio_gpio_ack_irq\n"); } }
...
{
	{ static char __rhcov_fn_ftgpio_gpio_mask_irq = 0; if (!__rhcov_fn_ftgpio_gpio_mask_irq) { __rhcov_fn_ftgpio_gpio_mask_irq = 1; pr_info("[rhcov] ftgpio_gpio_mask_irq\n"); } }
	struct gpio_chip *gc = irq_data_get_irq_chip_data(d);
	struct driver_priv *priv = gc ? gpiochip_get_data(gc) : NULL;
	void __iomem *base;
	u32 val;
...
{
	{ static char __rhcov_fn_ftgpio_gpio_unmask_irq = 0; if (!__rhcov_fn_ftgpio_gpio_unmask_irq) { __rhcov_fn_ftgpio_gpio_unmask_irq = 1; pr_info("[rhcov] ftgpio_gpio_unmask_irq\n"); } }
	struct gpio_chip *gc = irq_data_get_irq_chip_data(d);
	struct driver_priv *priv = gc ? gpiochip_get_data(gc) : NULL;
	void __iomem *base;
	u32 val;
...
{
	{ static char __rhcov_fn_ftgpio_gpio_set_irq_type = 0; if (!__rhcov_fn_ftgpio_gpio_set_irq_type) { __rhcov_fn_ftgpio_gpio_set_irq_type = 1; pr_info("[rhcov] ftgpio_gpio_set_irq_type\n"); } }
	struct gpio_chip *gc = irq_data_get_irq_chip_data(d);
	struct driver_priv *priv = gc ? gpiochip_get_data(gc) : NULL;
	void __iomem *base;
...
{
	{ static char __rhcov_fn_ftgpio_gpio_irq_handler = 0; if (!__rhcov_fn_ftgpio_gpio_irq_handler) { __rhcov_fn_ftgpio_gpio_irq_handler = 1; pr_info("[rhcov] ftgpio_gpio_irq_handler\n"); } }
...
{
	{ static char __rhcov_fn_ftgpio_gpio_set_config = 0; if (!__rhcov_fn_ftgpio_gpio_set_config) { __rhcov_fn_ftgpio_gpio_set_config = 1; pr_info("[rhcov] ftgpio_gpio_set_config\n"); } }
...
{
	{ static char __rhcov_fn_ftgpio_gpio_probe__gpio_generic_get = 0; if (!__rhcov_fn_ftgpio_gpio_probe__gpio_generic_get) { __rhcov_fn_ftgpio_gpio_probe__gpio_generic_get = 1; pr_info("[rhcov] ftgpio_gpio_probe__gpio_generic_get\n"); } }
	struct driver_priv *priv = ftgpio_priv_from_gc(gc);
	void __iomem *base = priv->base;
	u32 value;
...
{
	{ static char __rhcov_fn_ftgpio_gpio_probe__gpio_generic_get_multiple = 0; if (!__rhcov_fn_ftgpio_gpio_probe__gpio_generic_get_multiple) { __rhcov_fn_ftgpio_gpio_probe__gpio_generic_get_multiple = 1; pr_info("[rhcov] ftgpio_gpio_probe__gpio_generic_get_multiple\n"); } }
	struct driver_priv *priv = ftgpio_priv_from_gc(gc);
	void __iomem *base = priv->base;
	u32 value;
...
int ftgpio_gpio_probe__gpio_generic_set(struct gpio_chip *gc, unsigned int offset,
					int value)
{
	{ static char __rhcov_fn_ftgpio_gpio_probe__gpio_generic_set = 0; if (!__rhcov_fn_ftgpio_gpio_probe__gpio_generic_set) { __rhcov_fn_ftgpio_gpio_probe__gpio_generic_set = 1; pr_info("[rhcov] ftgpio_gpio_probe__gpio_generic_set\n"); } }
	struct driver_priv *priv = ftgpio_priv_from_gc(gc);
	void __iomem *base = priv->base;
...
int ftgpio_gpio_probe__gpio_generic_set_multiple(struct gpio_chip *gc,
						 unsigned long *mask, unsigned long *bits)
{
	{ static char __rhcov_fn_ftgpio_gpio_probe__gpio_generic_set_multiple = 0; if (!__rhcov_fn_ftgpio_gpio_probe__gpio_generic_set_multiple) { __rhcov_fn_ftgpio_gpio_probe__gpio_generic_set_multiple = 1; pr_info("[rhcov] ftgpio_gpio_probe__gpio_generic_set_multiple\n"); } }
	struct driver_priv *priv = ftgpio_priv_from_gc(gc);
	void __iomem *base = priv->base;
...
int ftgpio_gpio_probe__gpio_generic_direction_input(struct gpio_chip *gc,
						      unsigned int offset)
{
	{ static char __rhcov_fn_ftgpio_gpio_probe__gpio_generic_direction_input = 0; if (!__rhcov_fn_ftgpio_gpio_probe__gpio_generic_direction_input) { __rhcov_fn_ftgpio_gpio_probe__gpio_generic_direction_input = 1; pr_info("[rhcov] ftgpio_gpio_probe__gpio_generic_direction_input\n"); } }
	struct driver_priv *priv = ftgpio_priv_from_gc(gc);
	void __iomem *base = priv->base;
...
{
	{ static char __rhcov_fn_ftgpio_gpio_probe__gpio_generic_direction_output = 0; if (!__rhcov_fn_ftgpio_gpio_probe__gpio_generic_direction_output) { __rhcov_fn_ftgpio_gpio_probe__gpio_generic_direction_output = 1; pr_info("[rhcov] ftgpio_gpio_probe__gpio_generic_direction_output\n"); } }
	struct driver_priv *priv = ftgpio_priv_from_gc(gc);
	void __iomem *base = priv->base;
	u32 shadow_dir;
...
int ftgpio_gpio_probe__gpio_generic_get_direction(struct gpio_chip *gc,
						     unsigned int offset)
{
	{ static char __rhcov_fn_ftgpio_gpio_probe__gpio_generic_get_direction = 0; if (!__rhcov_fn_ftgpio_gpio_probe__gpio_generic_get_direction) { __rhcov_fn_ftgpio_gpio_probe__gpio_generic_get_direction = 1; pr_info("[rhcov] ftgpio_gpio_probe__gpio_generic_get_direction\n"); } }
	struct driver_priv *priv = ftgpio_priv_from_gc(gc);
	void __iomem *base = priv->base;
	u32 direction;
...
{
	{ static char __rhcov_fn_ftgpio_gpio_probe = 0; if (!__rhcov_fn_ftgpio_gpio_probe) { __rhcov_fn_ftgpio_gpio_probe = 1; pr_info("[rhcov] ftgpio_gpio_probe\n"); } }
