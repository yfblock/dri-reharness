...
Pipeline:
  ...
  2. IR stub: replace opaque declare with define stubs (tools/build/ir_stub.py)
  3. llvm-as: .ll → .bc
...
def _generate_stubbed_bc(source: str, linux_root: str | None = None,
    ...
    elimination), applies IR stubbing (tools/build/ir_stub.py), then llvm-as.
    """
    repo = Path(__file__).resolve().parents[2]
    tools_dir = os.fspath(repo / "tools/build")
