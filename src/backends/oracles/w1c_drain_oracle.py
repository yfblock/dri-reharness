...
from backends.subsystem_runner import w1c_drain_plan
...
def verify_w1c_drain_suite() -> dict:
    ...
    from backends import harness

    import json as _json
    _cases = _json.loads((ROOT / "benchmarks" / "holdout" /
                          "source-differential-cases.json").read_text(
                              encoding="utf-8"))["suites"]["w1c_drain"]
    source = _cases["altera"]
