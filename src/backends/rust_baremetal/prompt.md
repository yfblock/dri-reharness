...
## Rules
- Address fidelity: every RIS address expression is a source-derived
  ...
  dynamic address with a constant offset.
...
RIS module operations — the authoritative op list. One module per method,
ops in source order:
```
__RIS__
```
