...
- multi-source：真实 Kbuild 模块 C67X00（4 C）、ASPEED vHub（5 C）和 DWC2（10 C），跨 TU MMIO 传播与三后端编译通过。
- tests：58 passed。
...
~~~text
19 drivers, 425 ops
314 symbolic, 62 fixed, 35 computed
71 RMW, 58 conditions, 141 registers
compile: harness=19, bare-metal=19, Linux=19
strict ready: harness=7, bare-metal=7, Linux=7
LLM synthesis ready=12
multi-source: 3 modules, 19 TUs, 27447 LoC, 4121 ops, H/B/L compile=3/3
~~~
...
- Linux 19/19 Kbuild，严格 ready 为 7/19；Harness/Bare 也为 7/19。
- SVF 外部工具链成本较高，默认关闭。
