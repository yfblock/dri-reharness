...
Harness, bare-metal, and Linux outputs compile for \EvalDrivers{}/\EvalDrivers{} drivers. In contrast, only \LinuxReadyCount{}/\EvalDrivers{} currently satisfies strict Linux readiness, and \LLMReadyCount{}/\EvalDrivers{} have sufficient structured context for assisted synthesis. This is intentional: computed addresses, unknown RMW transforms, clang errors, and normalized source-private state all block readiness even when neutralized code can be compiled. The mean RIS quality is \EvalMeanRIS{}.
